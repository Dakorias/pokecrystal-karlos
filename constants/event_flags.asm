...
; Monego Isles story events
	...
	const EVENT_LASS_BATTLE_HERALD_ROUTE
	...
	const EVENT_TOURNAMENT_ROUND_1_BEAT
	const EVENT_TOURNAMENT_ROUND_2_BEAT
	const EVENT_TOURNAMENT_ROUND_3_BEAT
	const EVENT_BERRY_MASTER_POKEFAN_M
	const EVENT_BERRY_FOREST_MASTER_FINISHED
	const EVENT_BERRY_MASTER_GIVES_BERRIES
...
; Breeder
	const EVENT_BEAT_BREEDER_DAWN

; BugManiac
	const EVENT_BEAT_BUG_MANIAC_EDWIN
...
; Ranger
	const EVENT_BEAT_RANGER_GERALD
...
; Survivalist
	...
	const EVENT_BEAT_SURVIVALIST_JOHN

; Farmer

; Gardener
	const EVENT_BEAT_GARDENER_LILY
...
; Monego itemballs
	...
	const EVENT_CRAGGY_BEACH_KRABBY
	const EVENT_SCENIC_BLUFF_PEARL
	const EVENT_HERALD_BAY_GROTTO_TM46
	const EVENT_HERALD_BAY_TM54
	const EVENT_HERALD_BAY_GREAT_BALL
	const EVENT_HERALD_BAY_POTION
	const EVENT_RUGGED_CLIFF_RESCUE_BALL
	const EVENT_RUGGED_CLIFF_MUSCLE_BAND
	const EVENT_RUGGED_CLIFF_GROTTO_TM21
	const EVENT_BERRY_FOREST_MIRACLE_SEED
	const EVENT_BERRY_FOREST_SUPER_POTION
