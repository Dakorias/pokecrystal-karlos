...
DudnsparceFrontpic:  INCBIN "gfx/pokemon/dudnsparce/front.animated.2bpp.lz"
...
Lycanroc1Frontpic:   INCBIN "gfx/pokemon/lycanroc1/front.animated.2bpp.lz"
JolteonFrontpic:     INCBIN "gfx/pokemon/jolteon/front.animated.2bpp.lz"
Lycanroc2Frontpic:   INCBIN "gfx/pokemon/lycanroc2/front.animated.2bpp.lz"
Lycanroc3Frontpic:   INCBIN "gfx/pokemon/lycanroc3/front.animated.2bpp.lz"
...
CradillyFrontpic:  INCBIN "gfx/pokemon/cradilly/front.animated.2bpp.lz"
...
CaracostaFrontpic:     INCBIN "gfx/pokemon/caracosta/front.animated.2bpp.lz"
...
IronthornsFrontpic:     INCBIN "gfx/pokemon/ironthorns/front.animated.2bpp.lz"
...
VolcoronaFrontpic:      INCBIN "gfx/pokemon/volcorona/front.animated.2bpp.lz"
...
ShelgonBackpic:      INCBIN "gfx/pokemon/shelgon/front.animated.2bpp.lz"
...
RegilekiFrontpic:      INCBIN "gfx/pokemon/regileki/front.animated.2bpp.lz"
...
Lycanroc1Backpic:    INCBIN "gfx/pokemon/lycanroc1/back.2bpp.lz"
SeadraBackpic:       INCBIN "gfx/pokemon/seadra/back.2bpp.lz"
TwinsPic:            INCBIN "gfx/trainers/twins.2bpp.lz"
Lycanroc3Backpic:    INCBIN "gfx/pokemon/lycanroc3/back.2bpp.lz"
...
CradillyBackpic:   INCBIN "gfx/pokemon/cradilly/back.2bpp.lz"
...
DudnsparceBackpic:   INCBIN "gfx/pokemon/dudnsparce/back.2bpp.lz"
...
CaracostaBackpic:      INCBIN "gfx/pokemon/caracosta/back.2bpp.lz"
...
RegilekiBackpic:       INCBIN "gfx/pokemon/regileki/back.2bpp.lz"
...
VolcoronaBackpic:       INCBIN "gfx/pokemon/volcorona/back.2bpp.lz"
...
Lycanroc2Backpic:    INCBIN "gfx/pokemon/lycanroc2/back.2bpp.lz"
...
JirachiBackpic:      INCBIN "gfx/pokemon/claydol/back.2bpp.lz"
ManaphyBackpic:      INCBIN "gfx/pokemon/claydol/back.2bpp.lz"
...
IronthornsBackpic:       INCBIN "gfx/pokemon/ironthorns/back.2bpp.lz"
