...
MapGroup_SecondTown:
	table_width MAP_LENGTH, MapGroup_SecondTown
	map BeachRoute, TILESET_JOHTO, ROUTE, LANDMARK_BEACH_ROUTE, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map SecondTown, TILESET_JOHTO, TOWN, LANDMARK_SECOND_TOWN, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map MountainRoute, TILESET_JOHTO, ROUTE, LANDMARK_MOUNTAIN_ROUTE, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map MountainCave, TILESET_CAVE, CAVE, LANDMARK_MOUNTAIN_CAVE, MUSIC_BURNED_TOWER, FALSE, PALETTE_NITE, FISHGROUP_OCEAN
	map SecondTownHouse1, TILESET_HOUSE, INDOOR, LANDMARK_SECOND_TOWN, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SecondTownHouse2, TILESET_HOUSE, INDOOR, LANDMARK_SECOND_TOWN, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SecondTownPokecenter, TILESET_POKECENTER, INDOOR, LANDMARK_SECOND_TOWN, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SecondTownFishing, TILESET_HOUSE, INDOOR, LANDMARK_SECOND_TOWN, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map BeachGrotto, TILESET_JOHTO, ROUTE, LANDMARK_BEACH_ROUTE, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map MountainGym, TILESET_TOWER, INDOOR, LANDMARK_MOUNTAIN_CAVE, MUSIC_GYM, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_SECOND_TOWN_MAPS
