...
; ANIM_OBJ_ROCK_TOMB
	battleanimobj RELATIVE_X, $b0, BATTLEANIMFRAMESET_1B, BATTLEANIMFUNC_DROP, PAL_BATTLE_OB_BROWN, ANIM_GFX_ROCKS
...
; ANIM_OBJ_SAND_TOMB
	battleanimobj RELATIVE_X, $98, BATTLEANIMFRAMESET_2B, BATTLEANIMFUNC_SACRED_FIRE, PAL_BATTLE_OB_GRAY, ANIM_GFX_POWDER
...
; ANIM_OBJ_STONE_EDGE
	battleanimobj RELATIVE_X, $b0, BATTLEANIMFRAMESET_19, BATTLEANIMFUNC_RAPID_SPIN, PAL_BATTLE_OB_BROWN, ANIM_GFX_ROCKS
; ANIM_OBJ_SWAGGER
