...
Rival1Group:
	...
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, POUND
	...
	db 28, MAGNEMITE,  TACKLE, THUNDERSHOCK, POUND, THUNDER_WAVE
...
LassGroup:
	...
	db 29, AMPHAROS,   TACKLE, THUNDERSHOCK, THUNDER_WAVE, POUND
	db -1 ; end

	; LASS (16)
	db "DANA@", TRAINERTYPE_MOVES
	db 32, PIDGEY,    SCRATCH, DISABLE, CONFUSION, SCREECH
	db 32, AMPHAROS,   TACKLE, THUNDERPUNCH, THUNDER_WAVE, POUND
	db -1 ; end
...
PsychicGroup:
	...
	db 17, PIDGEY,   TACKLE, GROWL, WATER_GUN, NO_MOVE
