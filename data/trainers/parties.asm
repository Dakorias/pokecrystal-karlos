...
YoungsterGroup:
	...
	db  2, SHINX,		 DRACO_METEOR, NO_MOVE, NO_MOVE, NO_MOVE
	db  2, LUXIO,		 POUND, NO_MOVE, NO_MOVE, NO_MOVE
	db  2, LUXRAY,		 THUNDER_FANG, NO_MOVE, NO_MOVE, NO_MOVE
	db  2, BAGON,		 POUND, NO_MOVE, NO_MOVE, NO_MOVE
	db  2, SHELGON,		 POUND, NO_MOVE, NO_MOVE, NO_MOVE
	db  2, SALAMENCE,		 DRAGON_CLAW, NO_MOVE, NO_MOVE, NO_MOVE
	db -1 ; end

	; YOUNGSTER (2)
	db "TEST2@", TRAINERTYPE_MOVES
	db  2, COTTONEE,   QUIVER_DANCE, NO_MOVE, NO_MOVE, NO_MOVE
	db  2, TYPHLOSION,	ERUPTION, NO_MOVE, NO_MOVE, NO_MOVE
	db  2, MILOTIC,		 WATER_PULSE, NO_MOVE, NO_MOVE, NO_MOVE
	db  2, FEEBAS,		 HYDRO_CANNON, NO_MOVE, NO_MOVE, NO_MOVE
	db  2, WHIMSICOTT,		 HAIL, NO_MOVE, NO_MOVE, NO_MOVE
	db  2, PIDGEY,		 AVALANCHE, NO_MOVE, NO_MOVE, NO_MOVE
	db -1 ; end

	; YOUNGSTER (3)
	db "TEST3@", TRAINERTYPE_MOVES
	db  2, PIDGEY,		 POUND, NO_MOVE, NO_MOVE, NO_MOVE
	db  2, PIDGEY,		 POUND, NO_MOVE, NO_MOVE, NO_MOVE
	db  2, PIDGEY,		 POUND, NO_MOVE, NO_MOVE, NO_MOVE
	db  2, PIDGEY,		 POUND, NO_MOVE, NO_MOVE, NO_MOVE
	db  2, PIDGEY,		 POUND, NO_MOVE, NO_MOVE, NO_MOVE
