...
WhitneyGroup:
	...
	db 18, PIDGEY,   DOUBLESLAP, POUND, ENCORE, METRONOME
...
WillGroup:
	...
	db 41, PIDGEY,       DOUBLESLAP, LOVELY_KISS, ICE_PUNCH, PSYCHIC_M
...
PicnickerGroup:
	...
	db 31, PIDGEY,   ENCORE, SING, DOUBLESLAP, MINIMIZE
	db -1 ; end

	; PICNICKER (17)
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 37, PIDGEY,   ENCORE, DOUBLESLAP, MINIMIZE, METRONOME
	db -1 ; end
	...
	; PICNICKER (20)
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 20, PIDGEY,   ENCORE, SING, DOUBLESLAP, MINIMIZE
	db -1 ; end
...
TwinsGroup:
	...
	db 16, PIDGEY,   GROWL, ENCORE, DOUBLESLAP, METRONOME
