...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move COMET_PUNCH,  EFFECT_MULTI_HIT,          10, NORMAL,       100, 15,   0
	...
	move SIGNAL_BEAM,  EFFECT_CONFUSE_HIT,        65, BUG,          100, 20,  10
	move SWORDS_DANCE, EFFECT_ATTACK_UP_2,         0, NORMAL,       100, 30,   0
	move CUT,          EFFECT_NORMAL_HIT,         60, BUG,          100, 30,   0
	...
	move DARK_VOID,    EFFECT_DARK_VOID,          50, DARK,          80,  5,  60
	...
	move PIN_MISSILE,  EFFECT_MULTI_HIT,          10, BUG,          100, 20,   0
	...
	move DRAGON_RUSH,  EFFECT_PARALYZE_HIT,      100, NORMAL,        80, 10,   0
	...
	move BLIZZARD,     EFFECT_BLIZZARD,          110, ICE,           70,  5,  20
	...
	move FRENZY_PLANT, EFFECT_FRENZY_PLANT,      150, GRASS,        100,  5,   0
	...
	move FLASH_CANNON, EFFECT_DEFENSE_DOWN_HIT,   80, STEEL,        100, 15,  20
	move LICK,         EFFECT_PARALYZE_HIT,       20, GHOST,        100, 30,  30
	move SMOG,         EFFECT_POISON_HIT,         30, POISON,        75, 20,  50
	...
	move BRAVE_BIRD,   EFFECT_RECOIL_HIT,        120, FLYING,        85,  5,   0
	...
	move IRON_HEAD,    EFFECT_NORMAL_HIT,         80, STEEL,        100, 15,   0
	move HI_JUMP_KICK, EFFECT_JUMP_KICK,         110, FIGHTING,      90, 20,   0
	...
	move FURY_SWIPES,  EFFECT_MULTI_HIT,          10, NORMAL,        80, 15,   0
	...
	move BULLET_SEED,  EFFECT_MULTI_HIT,          10, GRASS,        100, 25,   0
	...
	move EARTH_POWER,  EFFECT_DEFENSE_DOWN_HIT,   85, GROUND,       100, 15,  10
	...
	move ARM_THRUST,   EFFECT_MULTI_HIT,          10, FIGHTING,     100, 25,   0
	move SAND_TOMB,    EFFECT_TRAP_TARGET,        35, GROUND,       100, 15,   0
	move AVALANCHE,    EFFECT_AVALANCHE,          80, ICE,          100, 15,   0
	move ZEN_HEADBUTT, EFFECT_FLINCH_HIT,         80, PSYCHIC_TYPE, 100, 15,   0
	...
	move CROSS_POISON, EFFECT_POISON_HIT,         50, POISON,       100, 20,  10
	move SAFEGUARD,    EFFECT_SAFEGUARD,           0, NORMAL,       100, 25,   0
	move PAIN_SPLIT,   EFFECT_PAIN_SPLIT,          0, NORMAL,       100, 20,   0
	move GUNK_SHOT,    EFFECT_POISON_HIT,        130, POISON,        90,  5,  30
  ...
  move CALM_MIND,    EFFECT_CALM_MIND,           0, PSYCHIC_TYPE, 100, 15,   0
	...
	move ROCK_BLAST,   EFFECT_MULTI_HIT,          10, ROCK,         100, 20,   0
